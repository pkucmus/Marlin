...
#define STRING_CONFIG_H_AUTHOR "(Pawel Kucmus, default config)" // Who made the changes.
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 708.13
  #define DEFAULT_bedKi 135.06
  #define DEFAULT_bedKd 928.19
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 144.22 } 
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER -0.52   // Z offset: -below +above  [the nozzle]
